...
const Summary = () => text(d.summary) ? <Section title="Profile" className="rt-summary"><p>{d.summary}</p></Section> : null;
  ...
  return <article className="rt-18 resume-template"><header className="rt-header"><h1>{p.name || 'Your Name'}</h1><h2>{p.title}</h2></header><div className="rt-body"><div className="rt-layout"><aside><Skills/><Certifications/></aside><main><Summary/><Experience/><Education/><Projects/></main></div></div></article>;
}
